...
export const OPTIONS: OptionDescriptions<Required<NativeParsedArgs>> = {
	...
	'aionui': { type: 'boolean', cat: 'o', description: localize('aionui', "Opens the AionUI window.") }, // test-workbench_change
	'openwork': { type: 'boolean', cat: 'o', description: localize('openwork', "Opens the OpenWork window.") }, // test-workbench_change
