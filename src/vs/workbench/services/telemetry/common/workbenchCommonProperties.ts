...
export function resolveWorkbenchCommonProperties(
	...
	const result = resolveCommonProperties(release, hostname, process.arch, commit, version, machineId, sqmId, devDeviceId, isInternalTelemetry, releaseDate, productService?.gitVersion); // test-workbench_change - pass gitVersion
