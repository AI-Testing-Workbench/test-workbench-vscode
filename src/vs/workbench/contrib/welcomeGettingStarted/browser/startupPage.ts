...
// import { isWeb } from '../../../../base/common/platform.js';  // test-workbench_change
...
export class StartupPageRunnerContribution extends Disposable implements IWorkbenchContribution {
	...
	constructor(
		...
		//@IChatEntitlementService private readonly chatEntitlementService: IChatEntitlementService,  // test-workbench_change
	) {
		super();
