...
// test-workbench_change: Disable Sentry in VS Code integration mode
// Sentry causes sentry-ipc:// protocol errors when running inside VS Code
// Only initialize Sentry in standalone Electron mode
const isVSCodeIntegration = (window as { electronAPI?: { isVSCodeIntegration?: boolean } }).electronAPI?.isVSCodeIntegration;

if (!isVSCodeIntegration && (window as { electronAPI?: unknown }).electronAPI) {
